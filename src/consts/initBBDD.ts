    ...
    defaultCourses: [
        {
            ...
            title: { es: "Peones", en: "Peones" },
            level: "Principiante",
            content: {
                detailDescription: { es: "Los peones son la base de toda estrategia en el ajedrez. Aunque parezcan simples, su correcto uso puede decidir una partida. Este curso te enseña lo esencial para dominar esta pieza clave.", en: "Los peones son la base de toda estrategia en el ajedrez. Aunque parezcan simples, su correcto uso puede decidir una partida. Este curso te enseña lo esencial para dominar esta pieza clave." },
                themes: [
                    {
                        id: 1,
                        images: [
                        ...
                        title: { es: "Posición inicial", en: "Posición inicial" },
                        description: { es: "Los peones se colocan en la segunda fila (fila 2) para las blancas y en la séptima fila (fila 7) para las negras. Forman la primera línea de defensa y controlan el centro desde el inicio.", en: "Los peones se colocan en la segunda fila (fila 2) para las blancas y en la séptima fila (fila 7) para las negras. Forman la primera línea de defensa y controlan el centro desde el inicio." },
                    },
                    {
                        id: 2,
                        images: [
                        ...
                        title: { es: "Movimiento", en: "Movimiento" },
                        description: { es: "Los peones avanzan solo hacia adelante, una casilla por turno, pero pueden avanzar dos casillas en su primer movimiento desde su posición inicial.", en: "Los peones avanzan solo hacia adelante, una casilla por turno, pero pueden avanzar dos casillas en su primer movimiento desde su posición inicial." },
                    },
                    {
                        id: 3,
                        images: [
                        ...
                        title: { es: "Captura", en: "Captura" },
                        description: { es: "A diferencia de su movimiento, los peones capturan en diagonal, una casilla hacia adelante. También existe una captura especial llamada 'al paso' que se estudia en niveles más avanzados.", en: "A diferencia de su movimiento, los peones capturan en diagonal, una casilla hacia adelante. También existe una captura especial llamada 'al paso' que se estudia en niveles más avanzados." },
                    },
                    {
                        id: 4,
                        images: [
                        ...
                        title: { es: "La coronación", en: "La coronación" },
                        description: { es: "Cuando un peón alcanza la última fila (fila 8 para blancas o fila 1 para negras), puede convertirse en dama, torre, alfil o caballo. Generalmente se elige la dama por su poder.", en: "Cuando un peón alcanza la última fila (fila 8 para blancas o fila 1 para negras), puede convertirse en dama, torre, alfil o caballo. Generalmente se elige la dama por su poder." },
                    },
                ],
            },
        },
        {
            ...
            title: { es: "Caballos", en: "Caballos" },
            level: "Principiante",
            content: {
                detailDescription: { es: "El caballo es la única pieza que puede saltar sobre otras y moverse en forma de L. Este curso básico te enseña cómo colocarlos y sacar ventaja con ellos desde el inicio.", en: "El caballo es la única pieza que puede saltar sobre otras y moverse en forma de L. Este curso básico te enseña cómo colocarlos y sacar ventaja con ellos desde el inicio." },
                themes: [
                    {
                        id: 1,
                        images: [
                        ...
                        title: { es: "Posición inicial", en: "Posición inicial" },
                        description: { es: "Cada jugador comienza con dos caballos: las blancas los colocan en b1 y g1, y las negras en b8 y g8. Están junto a las torres en las esquinas del tablero.", en: "Cada jugador comienza con dos caballos: las blancas los colocan en b1 y g1, y las negras en b8 y g8. Están junto a las torres en las esquinas del tablero." },
                    },
                    {
                        id: 2,
                        images: [
                        ...
                        title: { es: "Movimiento", en: "Movimiento" },
                        description: { es: "El caballo se mueve en forma de L: dos casillas en una dirección (horizontal o vertical) y una en dirección perpendicular. Además, puede saltar por encima de otras piezas.", en: "El caballo se mueve en forma de L: dos casillas en una dirección (horizontal o vertical) y una en dirección perpendicular. Además, puede saltar por encima de otras piezas." },
                    },
                    {
                        id: 3,
                        images: [
                        ...
                        title: { es: "Captura", en: "Captura" },
                        description: { es: "El caballo captura en la casilla donde termina su movimiento. Si hay una pieza enemiga en la casilla final de su salto en L, puede capturarla.", en: "El caballo captura en la casilla donde termina su movimiento. Si hay una pieza enemiga en la casilla final de su salto en L, puede capturarla." },
                    },
                    {
                        id: 4,
                        images: [
        ...
        },
        {
            ...
            title: { es: "Alfiles", en: "Alfiles" },
            level: "Principiante",
            content: {
                detailDescription: { es: "Los alfiles se mueven por diagonales y son muy poderosos en posiciones abiertas. En este curso aprenderás cómo se colocan, mueven, capturan y su importancia en el juego largo.", en: "Los alfiles se mueven por diagonales y son muy poderosos en posiciones abiertas. En este curso aprenderás cómo se colocan, mueven, capturan y su importancia en el juego largo." },
                themes: [
                    {
                        id: 1,
                        images: [
                        ...
                        title: { es: "Posición inicial", en: "Posición inicial" },
                        description: { es: "Las blancas colocan sus alfiles en c1 y f1; las negras en c8 y f8. Cada alfil permanece en un color específico durante toda la partida (blanco o negro).", en: "Las blancas colocan sus alfiles en c1 y f1; las negras en c8 y f8. Cada alfil permanece en un color específico durante toda la partida (blanco o negro)." },
                    },
                    {
                        id: 2,
                        images: [
                        ...
                        title: { es: "Movimiento", en: "Movimiento" },
                        description: { es: "Los alfiles se mueven en diagonal, tantas casillas como estén libres, pero siempre en una sola dirección por turno.", en: "Los alfiles se mueven en diagonal, tantas casillas como estén libres, pero siempre en una sola dirección por turno." },
                    },
                    {
                        id: 3,
                        images: [
                        ...
                        title: { es: "Captura", en: "Captura" },
                        description: { es: "El alfil captura de la misma forma en que se mueve: en línea diagonal. Puede eliminar cualquier pieza enemiga que esté en su camino.", en: "El alfil captura de la misma forma en que se mueve: en línea diagonal. Puede eliminar cualquier pieza enemiga que esté en su camino." },
                    },
                    {
                        id: 4,
                        images: [
        ...
        },
        {
            ...
            title: { es: "Torres", en: "Torres" },
            level: "Principiante",
            content: {
                detailDescription: { es: "Las torres son piezas fuertes que controlan filas y columnas. En este curso aprenderás sus movimientos básicos, cómo capturar con ellas y por qué son tan importantes en el final.", en: "Las torres son piezas fuertes que controlan filas y columnas. En este curso aprenderás sus movimientos básicos, cómo capturar con ellas y por qué son tan importantes en el final." },
                themes: [
                    {
                        id: 1,
                        images: [
                        ...
                        title: { es: "Posición inicial", en: "Posición inicial" },
                        description: { es: "Las torres se ubican en las esquinas del tablero. Las blancas en a1 y h1; las negras en a8 y h8. Protegen los bordes y se activan especialmente después del enroque.", en: "Las torres se ubican en las esquinas del tablero. Las blancas en a1 y h1; las negras en a8 y h8. Protegen los bordes y se activan especialmente después del enroque." },
                    },
                    {
                        id: 2,
                        images: [
                        ...
                        title: { es: "Movimiento", en: "Movimiento" },
                        description: { es: "La torre se mueve en línea recta a través de filas (horizontal) y columnas (vertical), tantas casillas como estén disponibles.", en: "La torre se mueve en línea recta a través de filas (horizontal) y columnas (vertical), tantas casillas como estén disponibles." },
                    },
                    {
                        id: 3,
                        images: [
                        ...
                        title: { es: "Captura", en: "Captura" },
                        description: { es: "La torre captura igual que se mueve: puede eliminar cualquier pieza enemiga ubicada en su misma fila o columna si no hay piezas entre medio.", en: "La torre captura igual que se mueve: puede eliminar cualquier pieza enemiga ubicada en su misma fila o columna si no hay piezas entre medio." },
                    },
                    {
                        id: 4,
                        images: [
                        ...
                        title: { es: "Activación", en: "Activación" },
                        description: { es: "Una torre es más poderosa en columnas abiertas (sin peones). Aprenderás a conectar tus torres y colocarlas en columnas donde tengan máxima actividad.", en: "Una torre es más poderosa en columnas abiertas (sin peones). Aprenderás a conectar tus torres y colocarlas en columnas donde tengan máxima actividad." },
                    },
                ],
            },
        },
        {
            ...
            title: { es: "Reina", en: "Reina" },
            level: "Principiante",
            content: {
                detailDescription: { es: "La dama es la pieza más poderosa del tablero, combinando el movimiento del alfil y la torre. Aprende cómo usarla sin exponerla demasiado.", en: "La dama es la pieza más poderosa del tablero, combinando el movimiento del alfil y la torre. Aprende cómo usarla sin exponerla demasiado." },
                themes: [
                    {
                        id: 1,
                        images: [
                        ...
                        title: { es: "Posición inicial", en: "Posición inicial" },
                        description: { es: "La reina blanca se coloca en d1 y la reina negra en d8. Siempre empieza en la casilla de su mismo color: blanca en blanca, negra en negra.", en: "La reina blanca se coloca en d1 y la reina negra en d8. Siempre empieza en la casilla de su mismo color: blanca en blanca, negra en negra." },
                    },
                    {
                        id: 2,
                        images: [
                        ...
                        title: { es: "Movimiento", en: "Movimiento" },
                        description: { es: "La reina puede moverse en línea recta por filas, columnas y diagonales, combinando el poder de la torre y el alfil en una sola pieza.", en: "La reina puede moverse en línea recta por filas, columnas y diagonales, combinando el poder de la torre y el alfil en una sola pieza." },
                    },
                    {
                        id: 3,
                        images: [
                        ...
                        title: { es: "Captura", en: "Captura" },
                        description: { es: "Captura cualquier pieza enemiga que esté en su camino de movimiento, tanto en línea recta como en diagonal.", en: "Captura cualquier pieza enemiga que esté en su camino de movimiento, tanto en línea recta como en diagonal." },
                    },
                    {
                        id: 4,
                        images: [
                        ...
                        title: { es: "Uso temprano", en: "Uso temprano" },
                        description: { es: "Aunque poderosa, no conviene sacarla demasiado pronto. Aprende cuándo y cómo usarla correctamente sin exponerla a ataques innecesarios.", en: "Aunque poderosa, no conviene sacarla demasiado pronto. Aprende cuándo y cómo usarla correctamente sin exponerla a ataques innecesarios." },
                    },
                ],
            },
        },
        {
            ...
            level: "Principiante",
            content: {
                detailDescription: { es: "El rey es la pieza más importante: si lo atrapan, se pierde la partida. Aprende sus movimientos básicos, cómo protegerlo y cuándo puede ser activo.", en: "El rey es la pieza más importante: si lo atrapan, se pierde la partida. Aprende sus movimientos básicos, cómo protegerlo y cuándo puede ser activo." },
                themes: [
                    {
                        id: 1,
                        images: [
                        ...
                        title: { es: "Posición inicial", en: "Posición inicial" },
                        description: { es: "El rey blanco empieza en e1 y el rey negro en e8. Siempre se coloca entre el alfil de rey y la dama.", en: "El rey blanco empieza en e1 y el rey negro en e8. Siempre se coloca entre el alfil de rey y la dama." },
                    },
                    {
                        id: 2,
                        images: [
                        ...
                        title: { es: "Movimiento", en: "Movimiento" },
                        description: { es: "El rey se mueve una casilla en cualquier dirección: horizontal, vertical o diagonal. No puede moverse a una casilla amenazada.", en: "El rey se mueve una casilla en cualquier dirección: horizontal, vertical o diagonal. No puede moverse a una casilla amenazada." },
                    },
                    {
                        id: 3,
                        images: [
                        ...
                        title: { es: "Captura", en: "Captura" },
                        description: { es: "El rey nunca 'captura' en el sentido ofensivo: se debe mantener a salvo. Sin embargo, puede eliminar piezas enemigas si la casilla no está bajo ataque.", en: "El rey nunca 'captura' en el sentido ofensivo: se debe mantener a salvo. Sin embargo, puede eliminar piezas enemigas si la casilla no está bajo ataque." },
                    },
                    {
                        id: 4,
                        images: [
                        ...
                        title: { es: "El enroque", en: "El enroque" },
                        description: { es: "El enroque es un movimiento especial en ajedrez donde el rey y una de las torres se mueven al mismo tiempo. Sirve para proteger al rey, llevándolo a una posición más segura, y al mismo tiempo activar la torre. Para enrocar, el rey se mueve dos casillas hacia la torre, y la torre salta al otro lado del rey.", en: "El enroque es un movimiento especial en ajedrez donde el rey y una de las torres se mueven al mismo tiempo. Sirve para proteger al rey, llevándolo a una posición más segura, y al mismo tiempo activar la torre. Para enrocar, el rey se mueve dos casillas hacia la torre, y la torre salta al otro lado del rey." },
                    },
                ],
            },
        },
    ...
    opinions: [
        {
            id: 1,
            idUser: 1,
            text: { es: "La plataforma es muy intuitiva y fácil de usar.", en: "La plataforma es muy intuitiva y fácil de usar." },
        },
        {
            id: 2,
            idUser: 3,
            text: { es: "Excelente contenido y seguimiento de progreso.", en: "Excelente contenido y seguimiento de progreso." },
        },
        {
            id: 3,
            idUser: 5,
            text: { es: "Me encanta la variedad de cursos disponibles.", en: "Me encanta la variedad de cursos disponibles." },
        },
        {
            id: 4,
            idUser: 8,
            text: { es: "Una excelente plataforma para aprender y mejorar tu ajedrez.", en: "Una excelente plataforma para aprender y mejorar tu ajedrez." },
        },
        {
            id: 5,
            idUser: 11,
            text: { es: "La sección de análisis post-partida es brillante.", en: "La sección de análisis post-partida es brillante." },
        },
        {
            id: 6,
            idUser: 6,
            text: { es: "Muy buena para jugadores intermedios.", en: "Muy buena para jugadores intermedios." },
        },
        {
            id: 7,
            idUser: 2,
            text: { es: "Sería bueno añadir contenido en otros idiomas.", en: "Sería bueno añadir contenido en otros idiomas." },
        },
        {
            id: 8,
            idUser: 9,
            text: { es: "Los cursos están bien explicados y son útiles.", en: "Los cursos están bien explicados y son útiles." },
        },
        { id: 9, idUser: 12, text: { es: "Excelente relación calidad-precio.", en: "Excelente relación calidad-precio." } },
        { id: 10, idUser: 7, text: { es: "Fácil de navegar desde el móvil.", en: "Fácil de navegar desde el móvil." } },
    ],
    authors: [
        {
            id: 1,
            name: { es: "Laura Vega", en: "Laura Vega" },
            description: { es: "Gran Maestra con amplia experiencia en preparación de aperturas.", en: "Gran Maestra con amplia experiencia en preparación de aperturas." },
            level: "GM",
            elo: 2550,
        ...
        },
        {
            ...
            description: { es: "Experto en finales y entrenador reconocido.", en: "Experto en finales y entrenador reconocido." },
            level: "IM",
            elo: 2400,
        ...
        },
        {
            ...
            description: { es: "Gran Maestro con enfoque posicional. Entrenador de selecciones juveniles.", en: "Gran Maestro con enfoque posicional. Entrenador de selecciones juveniles." },
            level: "GM",
            elo: 2560,
        ...
        },
        {
            ...
            description: { es: "Colaborador y especialista en resolución de estudios tácticos.", en: "Colaborador y especialista en resolución de estudios tácticos." },
            level: "FM",
            elo: 2322,
        ...
        },
        {
            ...
            description: { es: "Entrenador con amplia experiencia en enseñanza a principiantes.", en: "Entrenador con amplia experiencia en enseñanza a principiantes." },
            level: "CM",
            elo: 2200,
        ...
        },
        {
            ...
            description: { es: "Especialista en aperturas y jugadora activa en torneos nacionales.", en: "Especialista en aperturas y jugadora activa en torneos nacionales." },
            level: "FM",
            elo: 2350,
        ...
        },
        {
            ...
            description: { es: "Jugador fuerte especializado en análisis de partidas de principiantes.", en: "Jugador fuerte especializado en análisis de partidas de principiantes." },
            level: "FM",
            elo: 2305,
        ...
        },
        {
            ...
            description: { es: "Gran Maestro y entrenador especializado en cálculo táctico.", en: "Gran Maestro y entrenador especializado en cálculo táctico." },
            level: "GM",
            elo: 2650,
        ...
        },
        {
            ...
            description: { es: "Autora de varios libros de táctica y entrenadora de nivel nacional.", en: "Autora de varios libros de táctica y entrenadora de nivel nacional." },
            level: "IM",
            elo: 2420,
        ...
        },
        {
            ...
            description: { es: "Especialista en tácticas con múltiples títulos internacionales.", en: "Especialista en tácticas con múltiples títulos internacionales." },
            level: "GM",
            elo: 2600,
        ...
        },
        {
            ...
            description: { es: "Maestra Internacional experta en estrategia y planificación.", en: "Maestra Internacional experta en estrategia y planificación." },
            level: "IM",
            elo: 2450,
        ...
        },
        {
            ...
            description: { es: "Psicóloga deportiva y Maestra Internacional femenina.", en: "Psicóloga deportiva y Maestra Internacional femenina." },
            level: "WIM",
            elo: 2300,
        ...
        },
        {
            ...
            description: { es: "Jugador y entrenador con amplia experiencia en torneos internacionales.", en: "Jugador y entrenador con amplia experiencia en torneos internacionales." },
            level: "FM",
            elo: 2370,
        ...
        },
        {
            ...
            description: { es: "Entrenadora y jugadora con especialización en estrategia dinámica.", en: "Entrenadora y jugadora con especialización en estrategia dinámica." },
            level: "IM",
            elo: 2420,
        ...
        },
        {
            ...
            description: { es: "Coach especializado en enseñanza para principiantes.", en: "Coach especializado en enseñanza para principiantes." },
            level: "CM",
            elo: 2150,
        ...
        },
        {
            ...
            description: { es: "Jugador y entrenador con experiencia en entrenamiento de medio juego.", en: "Jugador y entrenador con experiencia en entrenamiento de medio juego." },
            level: "IM",
            elo: 2430,
